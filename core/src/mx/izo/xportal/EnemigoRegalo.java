...
public class EnemigoRegalo {
    ...
    public EnemigoRegalo(Texture textura) {
        TextureRegion texturaEnemigo = new TextureRegion(textura);

        sprite = new Sprite(texturaEnemigo);

        TextureRegion[][] texturaPersonaje = texturaEnemigo.split(164,134);
        animacion = new Animation(0.20f,texturaPersonaje[0][0]);
        // Animación infinita
