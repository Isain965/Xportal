...
public class MiniGame1 implements Screen
{
    ...
    private void probarChoqueParedes() {
        ...
        //******************************
        if ( (capaPlataforma.getCell(celdaX,celdaY) != null || capaPlataforma.getCell(celdaX,celdaY+1) != null)&&!(Personaje.EstadoSalto.SUBIENDO == H.getEstadoSalto() || Personaje.EstadoSalto.BAJANDO == H.getEstadoSalto()) ) {
