...
public class PantallaPausa implements Screen {
    ...
    private mx.izo.xportal.Boton btnRegresar;

    //Regresa al juego
    private Texture texturaBackJuego;
    private mx.izo.xportal.Boton btnBackJuego;
...
*/
    ...
    public PantallaPausa(Plataforma plataforma) {
...
//        efecto = new ParticleEffect();
    ...
    private void cargarRecursos() {
        ...
        assetManager.load("PantallaRespal.png", Texture.class);    // Cargar imagen
    ...
    private void crearObjetos() {
        ...
        texturaAcercaDe = assetManager.get("PantallaRespal.png");
        texturaRegresar = assetManager.get("back.png");

        btnRegresar = new mx.izo.xportal.Boton(texturaRegresar);

        texturaBackJuego = assetManager.get("BtmPlay.png");
        btnBackJuego= new mx.izo.xportal.Boton(texturaBackJuego);
...
//        explosion.draw(batch, Gdx.graphics.getDeltaTime());
    ...
    public void dispose() {
        ...
        assetManager.unload("PantallaRespal.png");
...
//            explosion.reset();
        ...
        public boolean touchUp(int screenX, int screenY, int pointer, int button) {
            ...
            if (btnRegresar.contiene(x,y)){
                ...
                plataforma.setScreen(new mx.izo.xportal.PantallaJuego(plataforma));
            }
            return true;    // Indica que ya procesó el evento
        }
