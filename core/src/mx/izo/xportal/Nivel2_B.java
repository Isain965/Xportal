...
public class Nivel2_B implements Screen{
    ...
    private void crearObjetos() {
        ...
        mx.izo.xportal.EnemigoCalabaza enemigo1 = new mx.izo.xportal.EnemigoCalabaza(texturaEnemigo);
        enemigo1.setPosicion(1142,20);
        mx.izo.xportal.EnemigoCalabaza enemigo2 = new mx.izo.xportal.EnemigoCalabaza(texturaEnemigo);
        enemigo2.setPosicion(2284,20);
        mx.izo.xportal.EnemigoCalabaza enemigo3 = new mx.izo.xportal.EnemigoCalabaza(texturaEnemigo);
        ...
        mx.izo.xportal.EnemigoV enemigoV2 = new mx.izo.xportal.EnemigoV(texturaEnemigo2);
        enemigoV2.setPosicion(2000,990);
        mx.izo.xportal.EnemigoV enemigoV3 = new mx.izo.xportal.EnemigoV(texturaEnemigo2);
    ...
    public void render(float delta) { // delta es el tiempo entre frames (Gdx.graphics.getDeltaTime())
        ...
        if (!banderaPausa && !haPerdio) {
            ...
            for (mx.izo.xportal.EnemigoCalabaza enemigo : enemigos) {
            ...
            for (int i = 0; i < enemigosV.size(); i++) {
                mx.izo.xportal.EnemigoV enemigoV = enemigosV.get(i);
            ...
            for (int i = 0; i < enemigos.size(); i++) {
                mx.izo.xportal.EnemigoCalabaza enemigo = enemigos.get(i);
