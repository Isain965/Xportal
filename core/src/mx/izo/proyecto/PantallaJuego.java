...
public class PantallaJuego implements Screen{
    ...
    ArrayList<mx.izo.proyecto.Enemigo> enemigos = new ArrayList<mx.izo.proyecto.Enemigo>();
    ...
    private void crearObjetos() {
        ...
        mx.izo.proyecto.Enemigo enemigo1 = new mx.izo.proyecto.Enemigo(texturaEnemigo);
        enemigo1.setPosicion(1142,20);
        mx.izo.proyecto.Enemigo enemigo2 = new mx.izo.proyecto.Enemigo(texturaEnemigo);
        enemigo2.setPosicion(2284,20);
        mx.izo.proyecto.Enemigo enemigo3 = new mx.izo.proyecto.Enemigo(texturaEnemigo);
    ...
    public void render(float delta) { // delta es el tiempo entre frames (Gdx.graphics.getDeltaTime())
        ...
        if (!banderaPausa && !haPerdio) {
            ...
            for (mx.izo.proyecto.Enemigo enemigo : enemigos) {
            ...
            for (int i = 0; i < enemigos.size(); i++) {
                mx.izo.proyecto.Enemigo enemigo = enemigos.get(i);
