...
public class Nivel2_B implements Screen{
    ...
    private mx.izo.proyecto.PantallaCargando pantallaCargando;
    ...
    private mx.izo.proyecto.Personaje mario;
    ...
    ArrayList<mx.izo.proyecto.Bala> balas = new ArrayList<mx.izo.proyecto.Bala>();
    ArrayList<mx.izo.xportal.EnemigoCalabaza> enemigos = new ArrayList<mx.izo.xportal.EnemigoCalabaza>();
    ArrayList<mx.izo.proyecto.EnemigoV> enemigosV = new ArrayList<mx.izo.proyecto.EnemigoV>();
    //Balas enemigos
    ArrayList<mx.izo.proyecto.Bala> balasEnemigos = new ArrayList<mx.izo.proyecto.Bala>();
    ArrayList<mx.izo.proyecto.BalaV> balasEnemigosV = new ArrayList<mx.izo.proyecto.BalaV>();

    private boolean llaveA = false;
    private boolean llaveB = false;

    private int rango = 300;
    private mx.izo.proyecto.Bala balaAnterior;
    private mx.izo.proyecto.Bala balaAnteriorV;
    ...
    private void crearObjetos() {
        ...
        // Crear el personaje
        mario = new mx.izo.proyecto.Personaje(texturaPersonaje,texturaSalto,texturaPersonaje2);
        ...
        mx.izo.proyecto.EnemigoCalabaza enemigo1 = new mx.izo.proyecto.EnemigoCalabaza(texturaEnemigo);
        enemigo1.setPosicion(1142,20);
        mx.izo.proyecto.EnemigoCalabaza enemigo2 = new mx.izo.proyecto.EnemigoCalabaza(texturaEnemigo);
        enemigo2.setPosicion(2284,20);
        mx.izo.proyecto.EnemigoCalabaza enemigo3 = new mx.izo.proyecto.EnemigoCalabaza(texturaEnemigo);
        enemigo3.setPosicion(3426,20);
        enemigos.add(enemigo1);
        enemigos.add(enemigo2);
        enemigos.add(enemigo3);
        balaAnterior = new mx.izo.proyecto.Bala(texturaBalaPlanta);
        balaAnterior.setPosicion(enemigo1.getX(),641);


        mx.izo.proyecto.EnemigoV enemigoV1 = new mx.izo.proyecto.EnemigoV(texturaEnemigo2);
        enemigoV1.setPosicion(571,990);
        mx.izo.proyecto.EnemigoV enemigoV2 = new mx.izo.proyecto.EnemigoV(texturaEnemigo2);
        enemigoV2.setPosicion(2000,990);
        mx.izo.proyecto.EnemigoV enemigoV3 = new mx.izo.proyecto.EnemigoV(texturaEnemigo2);
        enemigoV3.setPosicion(2855,990);
        enemigosV.add(enemigoV1);
        enemigosV.add(enemigoV2);
        enemigosV.add(enemigoV3);
        balaAnteriorV = new mx.izo.proyecto.Bala(texturaBalaEmbudo);
    ...
    public void render(float delta) { // delta es el tiempo entre frames (Gdx.graphics.getDeltaTime())
        ...
        if (!banderaPausa && !haPerdio) {
            ...
            for (mx.izo.proyecto.EnemigoV enemigoV : enemigosV) {
                if (enemigoV.getVidas() > 0) {
                    ...
                    if ((mario.getX() >= enemigoV.getX() - rango) && (mario.getX() <= enemigoV.getX()) && (int) tiempoJuego == (tiempoDisparo/2) && banderaDisparo) {
                        mx.izo.proyecto.BalaV balaEnJuego = new mx.izo.proyecto.BalaV(texturaBalaEmbudo);
                    ...
                    for (mx.izo.proyecto.BalaV bala : balasEnemigosV) {
                        bala.render(batch);
                        banderaDisparo = true;
                    ...
                    for (mx.izo.proyecto.Bala bala : balas) {
            ...
            for (mx.izo.proyecto.EnemigoCalabaza enemigo : enemigos) {
                if (enemigo.getVidas() > 0) {
                    ...
                    if ((mario.getX() >= enemigo.getX() - rango) && (mario.getX() <= enemigo.getX()) && (int) (tiempoJuego) == tiempoDisparo && banderaDisparo) {
                        mx.izo.proyecto.Bala balaEnJuego = new mx.izo.proyecto.Bala(texturaBalaPlanta);
                    ...
                    for (mx.izo.proyecto.Bala bala : balasEnemigos) {
                        bala.render(batch, banderaDireccion);
                        banderaDisparo = true;
                        if ((bala.getX() >= mario.getX() && bala.getX() <= (mario.getX() + mario.getSprite().getWidth())) &&
            ...
            for (int i = 0; i < enemigosV.size(); i++) {
                mx.izo.proyecto.EnemigoV enemigoV = enemigosV.get(i);
            ...
            for (int i = 0; i < balasEnemigosV.size(); i++) {
                mx.izo.proyecto.BalaV balaV = balasEnemigosV.get(i);
                if (balaV.getX() == 0) {
            ...
            for (int i = 0; i < balas.size(); i++) {
                mx.izo.proyecto.Bala bala = balas.get(i);
            ...
            for (int i = 0; i < enemigos.size(); i++) {
                mx.izo.proyecto.EnemigoCalabaza enemigo = enemigos.get(i);
            ...
            for (int i = 0; i < balasEnemigos.size(); i++) {
                mx.izo.proyecto.Bala bala = balasEnemigos.get(i);
    ...
    private void moverPersonaje() {
        ...
        switch (mario.getEstadoMovimiento()) {
            case INICIANDO:     // Mueve el personaje en Y hasta que se encuentre sobre un bloque
                ...
                if (celda==null) {
                    ...
                    mario.setEstadoMovimiento(mx.izo.proyecto.Personaje.EstadoMovimiento.QUIETO);
                }
        ...
        if ( mario.getEstadoMovimiento()!= mx.izo.proyecto.Personaje.EstadoMovimiento.INICIANDO
                && (mario.getEstadoSalto() != mx.izo.proyecto.Personaje.EstadoSalto.SUBIENDO) ) {
            // Calcula la celda donde estaría después de moverlo
            int celdaX = (int) (mario.getX() / TAM_CELDA);
            int celdaY = (int) ((mario.getY() + mario.VELOCIDAD_Y) / TAM_CELDA);
            // Recuperamos la celda en esta posición
            ...
            if ( (celdaAbajo==null && celdaDerecha==null) || esCoin(celdaAbajo) || esCoin(celdaDerecha) ) {
                // Celda vacía, entonces el personaje puede avanzar
                mario.caer();
                mario.setEstadoSalto(mx.izo.proyecto.Personaje.EstadoSalto.CAIDA_LIBRE);
            }
                ...
                // Dejarlo sobre la celda que lo detiene
                mario.setPosicion(mario.getX(), (celdaY + 1) * TAM_CELDA);
                mario.setEstadoSalto(mx.izo.proyecto.Personaje.EstadoSalto.EN_PISO);
            }
        }
    ...
    private void probarChoqueParedes() {
        mx.izo.proyecto.Personaje.EstadoMovimiento estado = mario.getEstadoMovimiento();
        // Quitar porque este método sólo se llama cuando se está moviendo
        if ( estado!= mx.izo.proyecto.Personaje.EstadoMovimiento.MOV_DERECHA && estado!= mx.izo.proyecto.Personaje.EstadoMovimiento.MOV_IZQUIERDA){
            return;
        }
        float px = mario.getX();    // Posición actual
        // Posición después de actualizar
        px = mario.getEstadoMovimiento()== mx.izo.proyecto.Personaje.EstadoMovimiento.MOV_DERECHA? px+mario.getVelocidadPersonaje():
                px-mario.getVelocidadPersonaje();
        int celdaX = (int)(px/TAM_CELDA);   // Casilla del personaje en X
        if (mario.getEstadoMovimiento()== mx.izo.proyecto.Personaje.EstadoMovimiento.MOV_DERECHA) {
            ...
            if ( esPuertaA( capaPlataforma1.getCell(celdaX,celdaY) ) && llaveA ) {
                ...
                Timer.schedule(new Timer.Task() {
                    ...
                    public void run() {
                        ...
                        niveles.flush();
                        pantallaCargando = new mx.izo.proyecto.PantallaCargando(plataforma);
    ...
    public class ProcesadorEntrada extends InputAdapter
    {
        ...
        public boolean touchDown(int screenX, int screenY, int pointer, int button) {
            ...
            if (estadoJuego==EstadosJuego.JUGANDO) {
                ...
                if (btnDerecha.contiene(x, y) && mario.getEstadoMovimiento() != mx.izo.proyecto.Personaje.EstadoMovimiento.INICIANDO) {
                    ...
                    mario.setEstadoMovimiento(mx.izo.proyecto.Personaje.EstadoMovimiento.MOV_DERECHA);

                } else if (btnIzquierda.contiene(x, y) && mario.getEstadoMovimiento() != mx.izo.proyecto.Personaje.EstadoMovimiento.INICIANDO) {
                    // Tocó el botón izquierda, hacer que el personaje se mueva a la izquierda
                    banderaDireccion = true;
                    mario.setBanderaPosicion(banderaDireccion);
                    mario.setEstadoMovimiento(mx.izo.proyecto.Personaje.EstadoMovimiento.MOV_IZQUIERDA);
                    ...
                    sonidoPistola.play();
                    mx.izo.proyecto.Bala bala = new mx.izo.proyecto.Bala(texturaBala);
        ...
        public boolean touchUp(int screenX, int screenY, int pointer, int button) {
            ...
            if ( mario.getEstadoMovimiento()!= mx.izo.proyecto.Personaje.EstadoMovimiento.INICIANDO && (btnDerecha.contiene(x, y) || btnIzquierda.contiene(x,y)) ) {
                // Tocó el botón derecha, hacer que el personaje se mueva a la derecha
                mario.setEstadoMovimiento(mx.izo.proyecto.Personaje.EstadoMovimiento.QUIETO);
            }
            return true;    // Indica que ya procesó el evento
        ...
        public boolean touchDragged(int screenX, int screenY, int pointer) {
            ...
            if (x<Plataforma.ANCHO_CAMARA/2 && mario.getEstadoMovimiento()!= mx.izo.proyecto.Personaje.EstadoMovimiento.QUIETO) {
